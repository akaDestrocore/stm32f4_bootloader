...
fn main() {
    ...
    let app_addr: i32 = 0x08020000;
    let header_size: i32 = 0x200;
    let vector_addr: i32 = app_addr + header_size;
    ...
    let header_rs: String = format!(
        ...
        pub static mut IMAGE_HEADER: ::misc::image::ImageHeader = ::misc::image::ImageHeader {{
            image_magic: ::misc::image::IMAGE_MAGIC_APP,
            image_hdr_version: ::misc::image::IMAGE_VERSION_CURRENT,
            image_type: ::misc::image::IMAGE_TYPE_APP,
            version_major: 1,
            version_minor: 0,
            version_patch: 0,
            _padding: 0,
