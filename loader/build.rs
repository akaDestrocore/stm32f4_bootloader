...
fn main() {
    ...
    let loader_addr: i32 = 0x08004000;
    let header_size: i32 = 0x200;
    let vector_addr: i32 = loader_addr + header_size;
    ...
    let header_rs: String = format!(
        ...
        // Memory addresses
        pub const LOADER_ADDRESS: u32 = {:#x};
        ...
        pub static mut IMAGE_HEADER: ::misc::image::ImageHeader = ::misc::image::ImageHeader {{
            image_magic: ::misc::image::IMAGE_MAGIC_LOADER,
            image_hdr_version: ::misc::image::IMAGE_VERSION_CURRENT,
            image_type: ::misc::image::IMAGE_TYPE_LOADER,
            version_major: 1,
            version_minor: 0,
            version_patch: 0,
            _padding: 0,
