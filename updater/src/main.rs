...
Press \x1B[93m'L'\x1B[0m\x1B[96m to enter loader\x1B[0m\r\n";
...
fn display_menu(uart: &mut UartManager) {
    ...
    uart.send_string("\x1B[91m-- Updater v");
            ...
            if let Some(byte) = uart.read_byte() {
                ...
                match byte {
                    ...
                    b'F' | b'f' => {
                        ...
                        uart.send_string("\x1B[93m[\x1B[32m1\x1B[93m] \x1B[96m- Loader\x1B[0m\r\n");
                    ...
                    b'1' => {
                        if boot_option == BootOption::SelectUpdateTarget {
                            // start loader update
                            clear_screen(&mut uart);
                            uart.send_string("\r\n\x1B[92mUpdating loader...\x1B[0m\r\n");
                            uart.send_string("\r\n\x1B[96mSend file using XMODEM protocol with CRC-16. \x1B[0m\r\n\x1B[93mIf menu doesn't load after update is over, please press \
\x1B[96m\x1B[42m'Esc'\x1B[0m\r\n");     
...
\x1B[96m\x1B[42m'Esc'\x1B[0m\r\n");
                    ...
                    b'I' | b'i' => {
                        ...
                        // updater
                        uart.send_string("\x1B[96mUpdater (this image): \x1B[0m");
                        ...
                        // loader
                        uart.send_string("\x1B[96mLoader: \x1B[0m");
                        ...
                        uart.send_string("\r\n\x1B[96mPress \x1B[93m'Esc' \x1B[96mto return to menu...\x1B[0m\r\n");
